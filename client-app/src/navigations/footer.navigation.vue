...
const { MenuFooter, MenuFooterActived } = useNavigationComposable();

</script>
<template>
   <div class="flex flex-col w-full bg-white fixed bottom-0 border-t-[0px] z-20 shadow-2xl">
      <!-- Fist section Header -->
      <div class="flex justify-between w-11/12 m-auto py-2 ">
